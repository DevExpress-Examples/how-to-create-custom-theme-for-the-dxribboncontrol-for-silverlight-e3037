...
namespace DevExpress.Internal {
...
#endif
    public const string AssemblyCopyright = "Copyright (c) 2000-2011 Developer Express Inc.";
    public const string AssemblyCompany = "Developer Express Inc.";

    internal const int VersionId = 111;
    ...
    public const string MarketingVersion = "v2011 vol 1";
    public const string VirtDirSuffix = "_v11_1";
    ...
    public const string SRAssemblyAgScheduler = "DevExpress.AgScheduler" + VSuffix;
